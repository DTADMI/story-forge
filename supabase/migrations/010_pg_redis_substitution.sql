-- Migration 010: PostgreSQL Redis Substitution Layer
-- Replaces Upstash Redis for rate limiting, feature flags, caching, and AI monitoring
...
INSERT INTO feature_flags (name, enabled, type, value) VALUES
  ('redis_rate_limit', true, 'boolean', 'true'),
...
CREATE OR REPLACE FUNCTION public.record_failed_attempt(p_email TEXT, p_lockout_seconds INTEGER DEFAULT 900)
RETURNS JSONB LANGUAGE plpgsql SECURITY DEFINER SET search_path = ''
AS $$
