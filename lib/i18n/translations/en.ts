export const en = {
  ...
  auth: {
    signInTitle: "Sign In to StoryForge",
  ...
  projects: {
    ...
    hideLinkedEntities: "Hide Linked Entities",
    saving: "Saving...",
  },
  world: {
    title: "World Building",
    description: "Manage your story's characters, locations, timeline, and dialogue.",
    characters: "Characters",
    locations: "Locations",
    timeline: "Timeline",
    dialogues: "Dialogue Scenes",
    ...
    noEras: "No eras yet",
    createFirstCharacter: "Create your first character to bring your story to life.",
    createFirstLocation: "Create your first location to build your world's geography.",
    createEraDescription: "Create eras to organize your timeline into distinct periods.",
    characterProfile: "Character Profile",
    locationDetails: "Location Details",
    eraDetails: "Era Details",
    dragUpload: "Drag & drop or click to upload",
    fileTypes: "JPEG, PNG, WebP, GIF (max 5MB)",
  ...
  gamification: {
    ...
    pagesPerWeek: "Pages per week",
    scenesCompleted: "Scenes completed",
    panelsPerDay: "Panels per day",
  ...
  export: {
    ...
    epub: "EPUB",
    pdf: "PDF",
    exportProject: "Export project as",
    exportedAs: "Project exported as",
  },
  ai: {
    title: "AI Assistant",
    description: "AI-powered tools to enhance your writing",
    suggest: "AI Writing Suggestions",
    character: "AI Character Development",
    plot: "AI Plot Analysis",
    style: "AI Style Consistency",
    research: "AI Research Assistant",
    generating: "Generating...",
    analyzing: "Analyzing...",
    generateCharacter: "Generate Character Ideas",
    analyzePlot: "Analyze Story Structure",
    checkStyle: "Check Style Consistency",
    researchPlaceholder: "Ask about historical facts, science, culture...",
    researchButton: "Research",
    upgradeRequired: "AI features require a subscription. Upgrade your plan.",
    limitReached: "Daily AI request limit reached. Try again tomorrow.",
    usage: "Usage",
    remaining: "Remaining",
    of: "of",
    ...
    noSuggestions: "No suggestions generated yet.",
    ...
    notAvailable: "AI features are not available.",
