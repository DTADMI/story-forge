...
export default async function HomePage() {
  ...
  return (
    <main className="prose-lite mx-auto max-w-3xl px-6 py-10">
      ...
      <p>{label("description", "A gamified writing platform that helps you build worlds, track characters and relationships, and share your stories with the right audience. Stay motivated with streaks, goals, and gems — all while protecting your wellbeing.")}</p>
      ...
      <ul>
        <li>{label("howItWorks.step1", "Create projects and pick your preferred genre. Organize your story into entities like Characters, Locations, Timelines, Dialogues, and more.")}</li>
        <li>{label("howItWorks.step2", "Control visibility with privacy scopes: private, friends, public‑auth, or public‑anyone.")}</li>
        <li>{label("howItWorks.step3", "Earn gems when you hit your goals and use them to customize your experience or send gifts to friends.")}</li>
      </ul>

      <h2 className="mt-10">{label("tryBasics.title", "Try the basics")}</h2>
      <p>{label("tryBasics.description", "Explore our components and styling on the demo page, or browse the public feed to see sample stories shared by the community.")}</p>
