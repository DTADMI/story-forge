    ...
    <main className="mx-auto w-full max-w-3xl space-y-6 px-4 py-8">
      <section className="rounded-xl border border-slate-700 bg-slate-900/70 p-6">
        ...
        <p className="mt-2 text-sm text-slate-300">
          StoryForge can run as an installable web app. Install to your home screen for faster startup and
          better continuity when connectivity is unstable.
        </p>
      </section>
      ...
      <section className="rounded-xl border border-slate-700 bg-slate-900/70 p-6">
        ...
        <p className="mt-2 text-sm text-slate-300">
          If the app cannot reach the network, StoryForge serves an offline page and resumes normally
          when connectivity returns.
        </p>
        <div className="mt-4 flex gap-3">
          <Link className="rounded-md bg-indigo-500 px-4 py-2 text-sm font-semibold text-white" href="/">
            Back home
          </Link>
          <Link
