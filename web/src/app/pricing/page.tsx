        ...
        <main className="prose-lite mx-auto max-w-3xl px-6 py-12">
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
                <div className="rounded-lg border border-[color:var(--fg)]/15 p-6">
                    ...
                    <a className="mt-4 inline-block rounded-md bg-brand px-4 py-2 text-white" href="/signup">Get
                        Started</a>
                </div>
                <div className="rounded-lg border border-[color:var(--fg)]/15 p-6">
                    ...
                    <a className="mt-4 inline-block rounded-md border border-brand px-4 py-2 text-brand"
                       href="/signup">Upgrade</a>
                </div>
            </div>
