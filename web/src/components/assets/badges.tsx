...
export function BadgeQuillBronze({ className, size = 64 }: { className?: string; size?: number }) {
  return (
    ...
    >
      ...
      <text x="32" y="52" textAnchor="middle" fill="#CD7F32" fontSize="9" fontWeight="bold">
        1K
      </text>
    </svg>
  );
...
export function BadgeScrollSilver({ className, size = 64 }: { className?: string; size?: number }) {
  return (
    ...
    >
      ...
      <text x="32" y="56" textAnchor="middle" fill="#A8A8A8" fontSize="9" fontWeight="bold">
        5K
      </text>
    </svg>
  );
...
export function BadgeBookGold({ className, size = 64 }: { className?: string; size?: number }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M20 16h12l4 4v28l-4-4H20V16z"
        stroke="#FFD700"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path d="M32 16v28l4 4V20l-4-4z" stroke="#FFD700" strokeWidth="2" />
      <text x="32" y="54" textAnchor="middle" fill="#FFD700" fontSize="9" fontWeight="bold">
        10K
      </text>
    </svg>
  );
...
export function BadgeLibraryPlatinum({
  className,
  size = 64,
}: {
  className?: string;
  ...
  return (
    ...
    >
      ...
      <text x="32" y="54" textAnchor="middle" fill="#E5E4E2" fontSize="9" fontWeight="bold">
        50K
      </text>
    </svg>
  );
...
export function BadgeGalaxyDiamond({
  className,
  size = 64,
}: {
  className?: string;
  ...
  return (
    ...
    >
      ...
      <text x="32" y="54" textAnchor="middle" fill="#7B68EE" fontSize="9" fontWeight="bold">
        100K
      </text>
    </svg>
  );
...
export function BadgeFire({ className, size = 64 }: { className?: string; size?: number }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M32 12c-4 8-8 14-8 20 0 4.4 3.6 8 8 8s8-3.6 8-8c0-6-4-12-8-20z"
        fill="#FF4500"
        fillOpacity="0.5"
        stroke="#FF4500"
        strokeWidth="2"
      ...
      <text x="32" y="54" textAnchor="middle" fill="#FF4500" fontSize="8" fontWeight="bold">
        STREAK
      </text>
    </svg>
  );
...
export function BadgeCrown({ className, size = 64 }: { className?: string; size?: number }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M16 40l6-20 10 8 10-8 6 20H16z"
        stroke="#DAA520"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      ...
      <text x="32" y="56" textAnchor="middle" fill="#DAA520" fontSize="8" fontWeight="bold">
        LEGEND
      </text>
    </svg>
  );
