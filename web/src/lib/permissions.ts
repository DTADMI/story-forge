export const SUBSCRIPTION_LIMITS = {
  free: { maxProjects: 3, maxCharacters: 10, aiRequestsPerDay: 0, competitions: false, analytics: false },
  explorer: { maxProjects: 10, maxCharacters: 50, aiRequestsPerDay: 10, competitions: true, analytics: false },
  creator: { maxProjects: -1, maxCharacters: -1, aiRequestsPerDay: 100, competitions: true, analytics: true },
  lifetime: { maxProjects: -1, maxCharacters: -1, aiRequestsPerDay: 500, competitions: true, analytics: true },
} as const;

type SubscriptionTier = keyof typeof SUBSCRIPTION_LIMITS;
type UserForPerms = { subscriptionTier: string; role: string; _count?: { projects: number; characters: number } };
